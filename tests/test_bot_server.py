...
from scripts.bot_logic import extract_message, expand_search_keywords, format_constraint_collection, format_result_message, format_search_started_message, parse_job_command, parse_job_constraints, parse_update_interval_seconds, table_name_for_keyword
...
class BotServerTests(unittest.TestCase):
    ...
    def test_format_result_message(self):
        text = format_result_message("AI产品经理实习", "AI产品经理实习", "app1", "tbl1", {"stats": {"records_created": 1}}, next_update_hours=2)
